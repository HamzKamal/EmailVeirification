...
<form method="POST" action="{{ route('register') }}">
       ...
       @enderror
        ...
        <div id="Nom">
        <input type="text" placeholder="Nom" name="Nom" autocomplete="off" id="Nom" value="{{ old('name') }}" pattern="^[a-zA-Z ]+$"  inputmode="none" ></div>
    ...
    <div id="check2">
        <span id="ecriture"> <span style="color:rgba(0,0,0,0)">......</span> you already have a account. <a href="/login" style="color:#0063FF">Login</a></span>
    </div>
    <script>
